...
class TiredRecord(models.Model):
    ...
    startg = models.IntegerField(db_column='startG')  # Field name made lowercase.
    tired_score = models.FloatField()
    pitcher_type = models.IntegerField()
    total_rank = models.IntegerField()
    pos_rank = models.IntegerField()
    prev_total_rank = models.IntegerField()
    prev_pos_rank = models.IntegerField()
